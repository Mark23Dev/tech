...
DATABASES = {
    'default': dj_database_url.parse(config('postgres://FusionForce:Mark@localhost:5432/FutureFemTech
'))
}
...
DISCORD_REDIRECT_URI = 'http://localhost:8000/discord/callback/'  # Change as needed
